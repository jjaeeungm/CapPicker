    ...
    internal sealed class MainForm : Form
    {
        ...
        private void ImageColorPicked(Color color, Point point)
        {
            ...
            if (copied)
                ...
                statusColor.Text = String.Format(L10n.T("색상 {0} · 복사 실패", "Color {0} · copy failed"), hex);
            ClearToolSelection();
        }
        ...
        private void ApplyCaptureButtonLanguage(FlatButton button, string text, int width)
        {
            ...
            if (button.Font != null && !UiFonts.IsShared(button.Font)) button.Font.Dispose();
            button.Font = UiFonts.Flat9;
